...
type RateFilter = 'all' | 'cheapest' | 'fastest' | 'optimal';

interface FilterTabsProps {
  onFilterChange: (filter: RateFilter) => void;
  activeFilter: RateFilter;
}

export function FilterTabs({ onFilterChange, activeFilter }: FilterTabsProps) {
  return (
    <Tabs value={activeFilter} onValueChange={(value) => onFilterChange(value as RateFilter)} className="mb-6">
